...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/nescampos/mntagent.git
   cd mntagent
   ```
...
#### Read Operations
- **get_balance**: Check wallet balances on the Mantle Sepolia testnet
...
3. **Blockchain Integration**:
   ...
   - Operations are executed on the Mantle Sepolia testnet
